...
urlpatterns = [
    ...
    path('admins/database/student/<str:username>', admins_profile_student,name="admins_profile_student"),
    path('admins/database/teacher/<str:username>', admins_profile_teacher,name="admins_profile_teacher"),
